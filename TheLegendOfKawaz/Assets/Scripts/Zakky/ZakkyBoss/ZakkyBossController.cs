...
namespace Actor.Enemy
{
    ...
    public class ZakkyBossController : BaseActorController
    {
        // Bossのステート一覧
        private enum eState
        {
        ...
        // ステートマシン
        private StateMachine<ZakkyBossController> state_machine_;
        ...
        private void Start()
        {
            ...
            state_machine_ = new StateMachine<ZakkyBossController>(this);
        ...
        // 次の行動を思考するステート
        [System.Serializable]
        private class StateThink : StateMachine<ZakkyBossController>.StateBase
        {
            [SerializeField]
        ...
        // アイドリング状態
        [System.Serializable]
        private class StateIdle : StateMachine<ZakkyBossController>.StateBase
        {
            // 開始時に呼ばれる
            public override void OnStart()
            {
        ...
        // ダメージを受けたときの状態
        [System.Serializable]
        private class StateDamage : StateMachine<ZakkyBossController>.StateBase
        {
            // 開始時に呼ばれる
            public override void OnStart()
            {
        ...
        // 落下状態
        [System.Serializable]
        private class StateFall : StateMachine<ZakkyBossController>.StateBase
        {
            // 開始時に呼ばれる
            public override void OnStart()
            {
        ...
        // 行動1状態 弾を撃つ
        [System.Serializable]
        private class StateShot : StateMachine<ZakkyBossController>.StateBase
        {
            // 撃つ量
            [SerializeField]
        ...
        // ダッシュの予備動作 少し後ろに下がる
        [System.Serializable]
        private class StatePreDash : StateMachine<ZakkyBossController>.StateBase
        {
            [SerializeField]
        ...
        // ダッシュする
        [System.Serializable]
        private class StateDash : StateMachine<ZakkyBossController>.StateBase
        {
            [SerializeField]
        ...
        [System.Serializable]
        private class StateJump : StateMachine<ZakkyBossController>.StateBase
        {
            // 左右に揺れる周期
            [SerializeField]
        ...
        // 周囲に何発も弾を発射するステート
        [System.Serializable]
        private class StateSuperShot : StateMachine<ZakkyBossController>.StateBase
        {
            [SerializeField]
