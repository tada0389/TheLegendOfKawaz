...
namespace Bullet
{
    public class BulletSpawner : MonoBehaviour
    {
        ...
        // 発射する 弾を出せなかったらfalse
        public bool Shot(Vector2 pos, Vector2 dir, string opponent_tag, float init_speed = 1.0f, float life_time = -1f)
        {
            ...
            for(int i = 0; i < max_shot_num_; ++i)
            {
                if (!bullets_[index_].gameObject.activeSelf)
                {
                    ...
                    bullets_[index_].Init(pos, dir, damage_, opponent_tag, init_speed, life_time);
